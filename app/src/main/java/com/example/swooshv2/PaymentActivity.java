...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String trackingNumber = intent.getStringExtra("ParcelNo");
        String deliveryCourier = intent.getStringExtra("PPlatform");
        String parcelSize = intent.getStringExtra("PSize");
        String dropOffPlace = intent.getStringExtra("PPlaceOfDrop");
        String timeOfArrival = intent.getStringExtra("PTimeOfArrival");
        ...
        ((TextView) findViewById(R.id.tvNumberOfParcels)).setText("Number of Parcels: " + numberOfParcels);
        ...
        ((TextView) findViewById(R.id.tvParcelSize)).setText("Parcel Size: " + parcelSize);
        ...
        buttonConfirmPayment.setOnClickListener(v -> {
            ...
            for (String parcelNo : parcelNumbers) {
                parcelNo = parcelNo.trim();


                // Parcel data
                Map<String, Object> parcelData = new HashMap<>();
                parcelData.put("ParcelNo", parcelNo);
                parcelData.put("PPlatform", deliveryCourier);
                parcelData.put("PSize", parcelSize);
                parcelData.put("PPlaceOfDrop", dropOffPlace);
                parcelData.put("PTimeOfArrival", timeOfArrival);


                // Save parcel to "Parcels" collection
                firestore.collection("Parcels").document(parcelNo).set(parcelData);


                // Save parcel-pickup relationship in "Parcel_Pickups" subcollection
                Map<String, Object> parcelPickupData = new HashMap<>();
                //parcelPickupData.put("ParcelNo", parcelNo);
                parcelPickupData.put("PickupID", pickupID);
                parcelPickupData.put("ParcelNo", parcelNo);


                firestore.collection("Pickups")
                        .document(pickupID)
                        .collection("Parcel_Pickups")
                        .document(parcelNo)
                        .set(parcelPickupData);
            }


            // Redirect to RunnerTracking
            Intent trackingIntent = new Intent(PaymentActivity.this, RunnerTracking.class);
