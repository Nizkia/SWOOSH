...
public class FoodTracking extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = "FoodTracking";
    ...
    private void showDeliveryConfirmationDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("The runner has arrived! Please collect your food.")
                .setPositiveButton("OK", (dialog, which) -> {
                    fetchDeliveryCompletionTime();
                    //tvETA.setText("Delivery completed.");
                    tvStatus.setText("Delivery completed.");
                    Intent feedbackIntent = new Intent(FoodTracking.this, FeedbackActivity.class);
                    feedbackIntent.putExtra("PickupID", pickupID);
    ...
    private void updateETAFromPPPToUser() {
        ...
        LatLng guardLocation = new LatLng(dropOffLat, dropOffLng);
                ...
                .addOnSuccessListener(querySnapshot -> {
                    if (!querySnapshot.isEmpty()) {
                        ...
                        if (userGeoPoint != null) {
                            ...
                            fetchRunnerLocationAndDrawRoutes(guardLocation, userLocation);
                        } else {
                            Log.e(TAG, "User's UDormLoc field is null");
    ...
    private void fetchRunnerLocationAndDrawRoutes(LatLng guardLocation, LatLng userLocation) {
        firebaseFirestore.collection("Runners")
